...
def hello():
    ...
    cur = g.db.execute("select temp from temps order by timestamp  desc limit 1")
   ...
   #time
    ...
    """
    #Humidity
    cur = g.db.execute("select humidity from humid order by timestamp desc limit 1")
    curhumidity = cur.fetchone()[0]
    """    
